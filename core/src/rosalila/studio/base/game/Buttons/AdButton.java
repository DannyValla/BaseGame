 ...
 */
public class AdButton extends Actor {
    ...
    public AdButton(SpriteBatch sprite_batch)
    {
        this.sprite_batch = sprite_batch;
        this.icon = new Texture(Gdx.files.internal("heart_button.png"));
        this.is_down = false;
        ...
        this.addListener(new InputListener() {
            ...
            public void touchUp (InputEvent event, float x, float y, int pointer, int button) {
                is_down = false;
                Globals.game.setScreen(Globals.ad_screen);
            }
        });
    }
